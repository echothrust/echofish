        ...
        array(
            ...
            'items'=>array(
                array('label'=>'Home', 'url'=>array('/site/index')),
		                ...
		                array('label'=>'Facilities', 'url'=>array('/syslog/facility/admin'),'visible'=>!Yii::app()->user->isGuest),
		                array('label'=>'Severities', 'url'=>array('/syslog/severity/admin'),'visible'=>!Yii::app()->user->isGuest),
								)),
		                ...
		                array('label'=>'Hosts', 'url'=>array('/settings/host/admin'),'visible'=>!Yii::app()->user->isGuest),
...
<div class="container-fluid" id="page">
	...
	<div id="footer">
	  ...
	  <small style="float: right;">Echofish version <?php echo Yii::app()->params['echofish_version']?></small>
		</div><!-- footer -->
</div><!-- page -->
