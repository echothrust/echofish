...
class AbuserTrigger extends CActiveRecord {
  ...
  public function rules()
  {
    ...
    return array (
        array (
            'facility, severity, program,msg,pattern,grouping, capture, occurrence,active',
            'required' 
        ),
        array (
            'facility, severity, grouping, capture, occurrence, priority,active',
            'numerical',
            'integerOnly' => true 
        ),
        array (
        ...
        array (
            'id, facility, severity, program, msg, pattern, grouping, capture, description, occurrence, priority,active',
            'safe',
            'on' => 'search' 
        ) 
    );
