...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm', array(
	...
	<h5></h5>
	<?php echo $form->textFieldRow($model,'facility',array('class'=>'span5','maxlength'=>20),array('hint'=>'Enter an RFC 5424 facility number (0-23), or use "%" for any.')); ?>

	<?php echo $form->textFieldRow($model,'severity',array('class'=>'span5','maxlength'=>20),array('hint'=>'Enter an RFC 5424 severity level number (0-7), or use "%" for any.')); ?>
	...
	<?php echo $form->textAreaRow($model,'pattern',array('rows'=>6, 'cols'=>50,'class'=>'span5','maxlength'=>512),array('hint'=>'PCRE that will run against matched messages to extract abuser.')); ?>
