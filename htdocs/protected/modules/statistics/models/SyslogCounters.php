...
/**
 * This is the model class for table "syslog_counters".
 *
 * The followings are the available columns in table 'syslog_counters':
 * @property string $ctype
 * @property string $name
 * @property string $val
 */
class SyslogCounters extends CActiveRecord
{
	/**
	 ...
	 * @return SyslogCounters the static model class
	 */
