...
/**
 * This is the model class for table "archive_counters".
 *
 * The followings are the available columns in table 'archive_counters':
 * @property string $ctype
 * @property string $name
 * @property string $val
 */
class ArchiveCounters extends CActiveRecord
{
	/**
	 ...
	 * @return ArchiveCounters the static model class
	 */
