...
/**
 * This is the model class for table "archive_counters_daily".
 *
 * The followings are the available columns in table 'archive_counters_daily':
 * @property string $ctype
 * @property string $name
 * @property string $val
 * @property string $ts
 */
class ArchiveCountersDaily extends CActiveRecord
{
	/**
	 ...
	 * @return ArchiveCountersDaily the static model class
	 */
	...
	public function scopes()
	{
		...
		'todays_top_programs'=>array(
				'condition'=>'ctype="program" and ts=date(now())',
				'order'=>'val desc,name',
			),
