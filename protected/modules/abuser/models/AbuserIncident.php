...
class AbuserIncident extends CActiveRecord
{
  ...
  public $intelligent=false;
	...
	public function rules()
	{
		...
		return array(
			...
			array('trigger_id, counter, first_occurrence, last_occurrence', 'length', 'max'=>20),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, ip, intelligent,trigger_id, counter, first_occurrence, last_occurrence, ts,ipstr', 'safe', 'on'=>'search'),
			array('id, ip, intelligent,trigger_id, counter, first_occurrence, last_occurrence, ts,ipstr', 'safe', 'on'=>'intelligent'),
		);
	}
	...
	public function relations()
	{
      ...
      'AE'=> array(self::HAS_MANY, 'AbuserEvidence','incident_id'),
  ...
  {
    return array('select'=>'*,inet_ntoa(ip) as ipstr',);
  }
}
