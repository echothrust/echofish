...
class IncidentController extends Controller
{
	...
	{
		$model=new AbuserIncident;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['AbuserIncident']))
		{
			$model->attributes=$_POST['AbuserIncident'];
			if($model->save())
  ...
  {
    Yii::import('application.modules.thytis.models.*'); 
    $model=$this->loadModel($id);
    $this->render('whois',array('model'=>$model,'data'=>shell_exec("whois ".$model->ipstr)));
  }
